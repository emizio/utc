...
We also exposed the autogenerated `lib/` directory to effectively replicate what a published bundle would contain (a published bundle is made from contents of lib/).
